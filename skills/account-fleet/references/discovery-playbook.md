...
# for the distribution you installed (from a source checkout,
...
# JS-heavy pages (experimental; install the matching optional `js` extra, e.g.
# `pip install ".[js]"` from a source checkout)
